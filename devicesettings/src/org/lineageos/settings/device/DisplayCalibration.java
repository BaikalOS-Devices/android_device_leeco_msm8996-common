...
public class DisplayCalibration extends PreferenceActivity implements
    ...
    public static final String KEY_KCAL_LOCKED = "kcal_locked";
    ...
    private SwitchPreference mKcalLocked;
    ...
    private static final String COLOR_FILE_LOCK = "/sys/devices/platform/kcal_ctrl.0/kcal_lock";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mKcalLocked = (SwitchPreference) findPreference(KEY_KCAL_LOCKED);
        mKcalLocked.setChecked(mPrefs.getBoolean(DisplayCalibration.KEY_KCAL_LOCKED, false));
        mKcalLocked.setOnPreferenceChangeListener(this);
        ...
        mLocked = mPrefs.getBoolean(DisplayCalibration.KEY_KCAL_LOCKED, false);
    ...
    public static void restore(Context context) {
       ...
       boolean storeLocked = PreferenceManager
                .getDefaultSharedPreferences(context).getBoolean(DisplayCalibration.KEY_KCAL_LOCKED, false);

       if (storeEnabled) {

           UtilsKCAL.writeValue(COLOR_FILE_LOCK, "0");
           ...
           UtilsKCAL.writeValue(COLOR_FILE_LOCK, storeLocked ? "1" : "0");
    ...
    public void reset() {
        ...
        UtilsKCAL.writeValue(COLOR_FILE_LOCK, mLocked ? "1" : "0");
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mKcalEnabled) {
            ...
            mKcalColorTemp.setValue(cct);
            return true;
        } else if (preference == mKcalLocked) {
            Boolean locked = (Boolean) newValue;
            mLocked = locked;
            mPrefs.edit().putBoolean(KEY_KCAL_LOCKED, locked).commit();
            UtilsKCAL.writeValue(COLOR_FILE_LOCK, mLocked ? "1" : "0");
            return true;
